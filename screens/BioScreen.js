...
// One-page bio for Víctor Celorio, because he’s out here inventing and writing like it’s no big deal
const BioScreen = ({ navigate }) => {
  return (
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      <ScrollView style={{ flex: 1 }}>
        {/* Hero Section */}
        <View style={{ backgroundColor: '#000', padding: 20, alignItems: 'center' }}>
          <Text style={mainStyles.mainTitle}>Vhe</Text>
          <Text style={[mainStyles.screenText, { color: '#e5e7eb', fontSize: 18, textAlign: 'center' }]}>
        ...
        <View style={{ padding: 20 }}>
          ...
          <Text style={[mainStyles.screenText, { color: '#ccc', fontSize: 16, lineHeight: 24 }]}>
      ...
      {navigate && (
        <TouchableOpacity
          style={[mainStyles.button, { margin: 24, alignSelf: 'center' }]}
